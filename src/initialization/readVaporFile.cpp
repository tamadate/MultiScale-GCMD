		...
		if (iflag==1) {
			...
			while(getline(stream,tmp,'\t')) {
				...
				if (loop==1) {
					...
					||tmp=="#cg" ||tmp=="#ch"||tmp=="#cx"||tmp=="#cy"||tmp=="#cu"||tmp=="#cv"||tmp=="#cz") at.name="C(v)";
					else if(tmp=="#h1"||tmp=="#h2"||tmp=="#h3"||tmp=="#h4"||tmp=="#h5"||tmp=="#ha"
					||tmp=="#hc"||tmp=="#hn"||tmp=="#ho"||tmp=="#hp"||tmp=="#hs"||tmp=="#hw"||tmp=="#hx") at.name="H(v)";
					else if(tmp=="f") at.name="F(v)";
					else if(tmp=="cl") at.name="Cl(v)";
					else if(tmp=="br") at.name="Br(v)";
					else if(tmp=="i") at.name="I(v)";
					...
					||tmp=="#n+"||tmp=="#nu"||tmp=="#nv"||tmp=="#n7"||tmp=="#n8"||tmp=="#n9") at.name="N(v)";
